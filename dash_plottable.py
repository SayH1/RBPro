...
def continuedash(filenameinput):
    global filename
    filename = filenameinput
    print(filename,"ppppp")
    # df = pd.read_csv('https://raw.githubusercontent.com/plotly/datasets/master/solar.csv')
    df = gd.read_genedataset(filename)
    ...
    #         for column in df.columns[1:] if column in dff
    #     ]
